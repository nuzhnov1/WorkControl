...
class LoadCurrentStudentStatisticsUseCase @Inject internal constructor(
    private val repository: StatisticsRepository
) {

    suspend operator fun invoke(): LoadResult<Statistics> =
        repository.loadCurrentStudentStatistics()
}
