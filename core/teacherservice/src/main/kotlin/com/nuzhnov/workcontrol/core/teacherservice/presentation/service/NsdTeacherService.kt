package com.nuzhnov.workcontrol.core.teacherservice.presentation.service

import com.nuzhnov.workcontrol.core.teacherservice.presentation.notification.TeacherServiceNotificationManager
import com.nuzhnov.workcontrol.core.teacherservice.domen.usecase.GetTeacherServiceStateUseCase
import com.nuzhnov.workcontrol.core.teacherservice.domen.usecase.GetTeacherServiceNameUseCase
import com.nuzhnov.workcontrol.core.teacherservice.domen.usecase.internal.StartControlUseCase
import com.nuzhnov.workcontrol.core.teacherservice.domen.usecase.internal.UpdateTeacherServiceStateUseCase
import com.nuzhnov.workcontrol.core.teacherservice.domen.usecase.internal.UpdateTeacherServiceNameUseCase
import com.nuzhnov.workcontrol.core.teacherservice.domen.model.TeacherServiceState
import com.nuzhnov.workcontrol.core.teacherservice.domen.model.TeacherServiceState.*
import com.nuzhnov.workcontrol.core.teacherservice.domen.model.TeacherServiceError.*
import com.nuzhnov.workcontrol.core.teacherservice.di.annotation.TeacherServiceCoroutineScope
import com.nuzhnov.workcontrol.core.util.constant.VISIT_CONTROL_PROTOCOL_NAME
...
internal class NsdTeacherService : Service(), NsdManager.RegistrationListener {
    ...
    internal companion object {
        const val CONTENT_ACTIVITY_CLASS_NAME_EXTRA = "com.nuzhnov.workcontrol.core" +
                ".teacherservice.presentation.service.CONTENT_ACTIVITY_CLASS_NAME_EXTRA"

        const val NOTIFICATION_CHANNEL_ID_EXTRA = "com.nuzhnov.workcontrol.core" +
